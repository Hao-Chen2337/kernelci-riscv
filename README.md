...
| Area | State |
|---|---|
| PR1 test profile (4 YAMLs, 57 insertions) | ready — validate_yaml green; the official scheduler renders 3 job definitions from it |
...
| Upstream steps | #49 progress reply posted 2026-09-10 (per the local notes, not re-verified); PR1 open as [kernelci-pipeline#1599](https://github.com/kernelci/kernelci-pipeline/pull/1599) (first review round answered, waiting on the reviewer); the riscv kselftest support it needs as [kernelci/tuxlava#50](https://github.com/kernelci/tuxlava/pull/50); the tracking issue opened as [kernelci/kernelci-project#585](https://github.com/kernelci/kernelci-project/issues/585) (also per the local notes, not re-verified) |
