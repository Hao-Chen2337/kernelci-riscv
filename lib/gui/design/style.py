...
**The board and that tool are local working material and are not in this
repository.**  What is here is the extraction they produced, and it is the copy
the console actually serves - a snapshot of the design, kept in step with it by
whoever holds the board.
