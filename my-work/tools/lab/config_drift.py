...
#   python3 my-work/tools/lab/config_drift.py
#
#   # two specific builds, full listing capped at 20 lines per category
#   python3 my-work/tools/lab/config_drift.py --older 6a96... --newer 6a9d... --max-lines 20
#
#   # machine-readable report (and CI gate: exit 1 when drift > 0)
#   python3 my-work/tools/lab/config_drift.py --json
#
