...
spec = importlib.util.spec_from_file_location(
    "riscv_pull_worker",
    "/home/hao/kernelci-riscv/my-work/tools/lab/riscv_pull_worker.py")
worker = importlib.util.module_from_spec(spec)
spec.loader.exec_module(worker)

PASS_LOG = "/home/hao/kernelci-riscv/my-work/evidence/worker-out/job-1788797278/tuxrun.log"
FAIL_LOG = "/home/hao/kernelci-riscv/my-work/evidence/worker-out/job-1788796872/tuxrun.log"
